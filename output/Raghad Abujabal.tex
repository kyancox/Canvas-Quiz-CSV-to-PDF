...
1. SuperSort(A) { \\ sorts array A recursively2.    // base cases3.    if (length(A) == 1) return;4.    if (length(A) == 2) {5.       swap the two elements if they’re out of order;6.       return;7.    } else { // recursive calls8.       SuperSort the first two thirds of A;9.       SuperSort the second two thirds of A;10.      SuperSort the first two thirds of A again;11.    }12. }
